            ...
            <Fragment className="contenthome">
                <div className="slider">
                    <div className="slidercontent">
                            <img className="imageslider" src={require('../../images/banner-desktop2.jpg')} />
                    </div>
                </div>
                ...
                <div className="content">
                    ...
                    <div className="content-gambar">
                        ...
                        <div className="image">
                            <img className="imagesliderr" src={require('../../images/bpn.png')} />
                            <div className="contentimage">
                                <h2 className="fontimage">www.bpn.go.id</h2>
                            </div>
                        </div>
                        <div className="image">
                            <img className="imagesliderr" src={require('../../images/republika.png')} />
                            <div className="contentimage">
